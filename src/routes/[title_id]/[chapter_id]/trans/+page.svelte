<script lang="ts">
    ...
    let linesOrignalSorted = Object.entries(linesOrignal).toSorted((a, b) => parseInt(a[0]) - parseInt(b[0])).map(([_, v]) => v)
        ...
        <div class="lg:flex gap-4">
            ...
            <div class="lg:flex-1 lg:h-full">
                <div class="flex block">
                    ...
                    <div class="flex-1 block">
                        <select class="block font-bold text p-2 py-1">
                ...
                <div>
                    <div class="border min-h-20 rounded">
                        {#each linesOrignalSorted.map(v => [v, 'aaaa']) as line}
                            <div class="flex bg-slate-100 m-2">
                                <div class="p-2 min-h-10 flex-1 w-2/4" data-idx={line[0].id.lineNo}>
                                    {line[0].line}
                                </div>
                                <textarea
